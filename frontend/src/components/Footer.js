    ...
    <footer className="bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 text-white py-12">
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <div className="flex items-center space-x-6">
              <a href="https://example.com" className="text-gray-400 hover:text-purple-500">
            ...
            <p className="mt-6 text-sm text-gray-400">
              Connect with us on social media to stay updated with the latest Weather news .
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400">
              <li>
                <a href="https://example.com" className="hover:text-purple-500">
                  Submit Article
                </a>
              </li>
              <li>
        ...
        <div className="border-t border-gray-700 mt-12 pt-6 text-center text-sm text-gray-400">
          © {new Date().getFullYear()} WeatherFinder. All rights reserved.
        </div>
      </div>
    </footer>
  );
